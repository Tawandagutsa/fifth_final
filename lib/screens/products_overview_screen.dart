...
class _ProdcutsOverviewScreenState extends State<ProductsOverviewScreen> {
  var _showOnlyFavorites = false;
  var _isLoading = false;
  var _isInit = true;

  Future<void> _refreshProd(BuildContext context) async {
    Provider.of<Products>(context, listen: false).fetchAndSetProduct(context);
  }
  ...
  Widget build(BuildContext context) {
    // String name = Provider.of<Auth>(context, listen: false).user;
